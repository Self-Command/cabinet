...
const STRUCTURED_RE =
  /^(SUMMARY|CONTEXT|CONTEXT_UPDATE|ARTIFACT|FOLDER|DECISION|LEARNING|GOAL_UPDATE|MESSAGE_TO|LAUNCH_TASK|SCHEDULE_JOB|SCHEDULE_TASK|SEND_EMAIL)\s*(?:\[([^\]]*)\])?:\s*(.*)$/;
const TOKENS_RE = /^[\d,]+$/;
...
const STRUCTURED_LABELS =
  "SUMMARY|CONTEXT|CONTEXT_UPDATE|ARTIFACT|FOLDER|DECISION|LEARNING|GOAL_UPDATE|MESSAGE_TO|LAUNCH_TASK|SCHEDULE_JOB|SCHEDULE_TASK|SEND_EMAIL";
